...
def plot_line_graph(data):
    ...
    -------
    Nothing returns
    this function fetches the data and plot line graph on it.
...
def box_plot(data):
    ...
    -------
    Nothing returns
    this function fetches the data and plot box plot on it.
...
def plot_histogram(data):
    ...
    -------
    Nothing returns
    this function fetches the data and plot histogram on it.
